...
function refreshStatus() {
  ...
  playersCountEl.textContent = "1";
  playersListEl.innerHTML = `<tr><td><span class="table-player"><span class="color-dot"></span>Jugador local</span></td><td><span class="online-status">Conectado</span></td><td>${visited.size}</td></tr>`;
  top5ListEl.innerHTML = `<tr><td>1</td><td>Jugador local</td><td class="score-value">${visited.size}</td></tr>`;
}
